...
**Last updated:** 2026-08-22 (**S5 Bangla computational post-run COMPLETE;
human evaluation/interface preparation is next.**) The final, separately
...
registered scorer exists.**) **S4.6 COMPLETE under two documented protocol
...
> **Checked 2026-08-20 against the files on disk** — the hook
...
16. ▶ **Implement the Bangla §5.1 runner and tests next.** Ten conditions,
    Verifier-B outcome-only, eval plots never dev plots, no local generation;
    then package the Kaggle runner once CPU dry-run and invariants pass.
...
decision 5 (stylometry vs MGT framing), the CC BY-SA attribution checklist, and — the highest-risk item in
