...
**Last updated:** 2026-08-23 (**S5 Bangla computational post-run COMPLETE;
human-evaluation contract, interface builder and scorer are frozen; clean
interface instantiation is next.**) The final, separately
