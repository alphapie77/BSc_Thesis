...
| Base-paper reading | **6** Tier-1 | **6 briefed, 1 read in full** — `docs/base_papers_brief.md` (2026-08-01). ⚠️ **All by Claude; Sabbir has read none.** Depth is tagged per paper: Huang 📗 full text, the other five 📙 abstract + record. **Three need full-text reading before Ch.2**: MoP (does it human-validate personas?), Self-Correction Illusion (how big is the free intervention?), Kamoi (get the experiment-design checklist). | Ch.1, Ch.2, **§5.1 design** | 🔴 **highest.** The briefing already produced 3 open decisions (9, 10, 11) against a pre-registered ablation table — the reading is changing the design, which is the argument for finishing it before S6 |
