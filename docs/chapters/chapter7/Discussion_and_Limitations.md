...
not been inferred; these fields therefore remain unknown in the Human
Evaluation Data Sheet (HEDS) 3.0 record [@b32]. Appendix B reports the human
evaluation and consent record, and Appendix C consolidates the broader
responsible-NLP and artifact-release boundaries.
